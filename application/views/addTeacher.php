...
<div class="container">
	<?php echo form_open("Admin/createTeacher", ['class' => 'form-horizontal']);?>
    ...
    <div class="row">
    	<div class="col-md-6">
    		<div class="form-group">
    			...
    			<div class="col-md-9">
    				<?php echo form_input(['name' => 'teachername', 'class'=>'form-control', 'placeholder'=>'Teacher Name', 'value'=>set_value('teachername')]);?>
    			</div>
    		</div>
    	</div>
    	<div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <?php echo form_input(['name' => 'phnnum', 'class'=>'form-control', 'placeholder'=>'Phone Number', 'value'=>set_value('phnnum')]);?>
                </div>
            </div>
        </div>
        <div class="col-md-6">
